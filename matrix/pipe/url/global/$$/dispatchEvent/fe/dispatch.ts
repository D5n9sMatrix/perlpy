...
export class Dispatcher {
  ...
  /** Method to record cherry pick started via drag and drop and Cured. */
  public recordCherryPickDragStartedAndCured() {
    this.statsStore.recordCherryPickDragStartedAndCured()
  }
